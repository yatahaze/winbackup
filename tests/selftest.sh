...
mk "$S/Program Files (x86)/Warcraft III/Warcraft III.exe"
mk "$S/ProgramData/App/data"
mk "$S/ProgramData/Package Cache/big.msi"
mk "$S/Windows/System32/x"
mk "$S/Custom/thing.txt"
mk "$S/Apps/Diablo II/Game.exe"
mk "$S/Apps/Diablo IV/Diablo IV.exe"
mk "$S/Apps/World of Warcraft/_retail_/Data/data.001"
mk "$S/Apps/World of Warcraft/_retail_/Cache/x"
...
absent "$D5/WinBackup_$DATE/Apps/Diablo II"
absent "$D5/WinBackup_$DATE/Apps/Diablo IV"
absent "$D5/WinBackup_$DATE/Apps/World of Warcraft/_retail_/Data"
absent "$D5/WinBackup_$DATE/Apps/World of Warcraft/_retail_/Cache"
